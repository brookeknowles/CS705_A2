...
short src_ln0 [] = {
	  0,   7,   9,  10,  11,  13,  14,  15, 
	 17,  18,  19,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "Assignment_Q1.pml", 1, 10 },
	{ "-", 11, 12 }
};
uchar reached0 [] = {
	  0,   0,   0,   0,   0,   0,   0,   0, 
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		...
		logval("numCriticalProcesses", now.numCriticalProcesses);
#endif
}
...
{	/* int i; */
	...
	printf("	byte   numCriticalProcesses:	%d\n", now.numCriticalProcesses);
}
void
